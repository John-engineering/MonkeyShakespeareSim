...
Step 1: Install NumPy In Terminal/CMD (For Mac: "brew install numpy" For Windows: "pip install numpy")

Step 2: "cd [insert folder location]"

Step 3: For Mac: "python3 monkey_shakespeare.py" For Windows: "python monkey_shakespeare.py"
